...
public class DeleteSchedule extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		Logger.info("Begin of <--DeleteSchedule--> Servlet");
		String[] delete = request.getParameterValues("deleteschedules");
		...
		Logger.info("Calling the Brokerage-Service/" + Constants.DELETE_SCHEDULE);
		ClientResponse restResponse = ServiceUtil.getBrokerageServiceHandle(Constants.DELETE_SCHEDULE, formData);
		...
		Logger.info("End of <--DeleteSchedule--> Servlet");
	}
